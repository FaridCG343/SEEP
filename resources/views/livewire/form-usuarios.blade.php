    ...
    <x-form wire:submit.prevent="save">
            ...
            <div class="flex align-middle items-center gap-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="1.5em" height="1.5em" viewBox="0 0 24 24">
                    <g fill="none" stroke="#2AA8FF" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
                        color="#2AA8FF">
                        <path
                            d="M19 20.5c.425-.191.79-.439 1.109-.76c1.391-1.402 1.391-3.658 1.391-8.17c0-4.511 0-6.767-1.391-8.168C18.717 2 16.479 2 12 2C7.522 2 5.282 2 3.891 3.402S2.5 7.059 2.5 11.57s0 6.767 1.391 8.169c.32.321.684.569 1.109.76M2.5 8.5h19M7 5.5h.009M11 5.5h.009" />
                        <path
                            d="M10.26 16.378c-1.08 0-1.543.78-1.663 1.26c-.12.479-.12 2.218-.048 2.938c.24.899.84 1.27 1.428 1.39c.54.049 2.82.03 3.48.03c.96.019 1.68-.341 1.98-1.42c.06-.36.12-2.34-.03-2.939c-.318-.96-1.047-1.259-1.647-1.259m-3.5 0h3.5m-3.5 0c0-.06-.002-.826 0-1.26c0-.398-.034-.78.156-1.13c.71-1.413 2.75-1.27 3.254.17c.087.237.093.612.09.96c-.003.442 0 1.26 0 1.26" />
                    </g>
                </svg>
        ...
        <div class="flex h-48 pl-10 pr-10 space-x-4">
            ...
            <div class="card w-1/3 p-6 shadow-xl bg-white">
                <div class="flex align-middle items-center gap-2">
                    <svg xmlns="http://www.w3.org/2000/svg" width="1.5em" height="1.5em" viewBox="0 0 24 24">
                        <g fill="none" stroke="#2AA8FF" stroke-linecap="round" stroke-linejoin="round"
                            stroke-width="2">
                            <path d="M3 21h18M4 21V6a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v15" />
                            <path d="M9 21v-8a3 3 0 0 1 6 0v8" />
                        </g>
                    </svg>
                    <h1 class="font-bold text-lg text-color-title-ds">Departamentos</h1>
                </div>
                <div class="divider-norm"></div>
                <div class="font-regular text-color-title-ds text-xs">
                    <x-choices label="Departamento" wire:model="departamento_id" :options="$departamentos" single
                        class="select select-xs select-info bg-white !text-xs" />
                </div>
            </div>
        </div>
        ...
        <div class="flex card h-44 p-6 shadow-xl bg-white mr-10 ml-10">
            <div class="flex align-middle items-center gap-2">
                ...
                <h1 class="font-bold text-lg text-color-title-ds">Cedula profesional y especialidad</h1>
            </div>

            <div class="divider-norm"></div>

            <div class="font-regular text-color-title-ds text-xs grid grid-cols-2 gap-y-5 gap-x-10">
                <x-input wire:model="cedula_profesional" label="Cedula Profesional" icon="" hint=""
                    class="input input-xs input-info bg-white" />

                <x-choices label="Departamento" wire:model="especialidad_id" :options="$especialidades" single
                class="select select-xs select-info bg-white !text-xs" />
            </div>
        </div>
        <x-slot:actions>
