            ...
            <div class="bg-white h-full w-3/5 flex justify-center items-center">
                ...
                <div class=" flex-col justify-center items-center h-5/6 w-3/5 content-around space-y-6">
                    ...
                    <div class="flex justify-center items-center space-x-3">
                        <svg xmlns="http://www.w3.org/2000/svg" width="5em" height="5em" viewBox="0 0 24 24">
                            <defs>
                                <linearGradient id="gradient x1="0%" y1="0%" x2="0%" y2="100%">
                                  <stop offset="5%" stop-color="#9ECDFB" />
                                  <stop offset="95%" stop-color="#5EADFF" />
                                </linearGradient>
                              </defs>
                        ...
                        <h1 class="text-6xl font-black bg-gradient-to-t from-custom-color-2 via-custom-color-1 to-custom-color-3 text-gradient">SEEP</h1>
                    </div>
                    {{-- Log In Text --}}
